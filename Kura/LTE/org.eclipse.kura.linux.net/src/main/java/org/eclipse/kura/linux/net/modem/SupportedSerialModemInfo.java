...
public enum SupportedSerialModemInfo {
    ...
    SolidRun_Quectel_EC25("EC25", new String[] { "EC25" }, "Quectel", KuraConstants.Raspberry_Pi
            .getImageName(), KuraConstants.Raspberry_Pi.getImageVersion(), KuraConstants.Raspberry_Pi
                    .getTargetName(), Arrays.asList(ModemTechnologyType.HSPA,
                            ModemTechnologyType.LTE), new SerialModemDriver("EC25", SerialModemComm.Quectel,
                                    "at+gmm\r\n"));
