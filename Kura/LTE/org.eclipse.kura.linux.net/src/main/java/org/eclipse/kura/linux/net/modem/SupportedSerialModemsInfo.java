    ...
    public static SupportedSerialModemInfo getModem() {
        ...
        if (supportedSerialModemInfo != null) {
            ...
            if (OS_VERSION != null
                ...
                // Solidrun Raspberry_Pi

            } else if (OS_VERSION != null
                    && OS_VERSION.equals(KuraConstants.Raspberry_Pi.getImageName() + "_"
                            + KuraConstants.Raspberry_Pi.getImageVersion())
                    && TARGET_NAME != null && TARGET_NAME.equals(KuraConstants.Raspberry_Pi.getTargetName())) {
                logger.debug("obtaining serial modem info for {}", KuraConstants.Raspberry_Pi.getImageName());
                supSerialModemInfo = SupportedSerialModems.getModem(KuraConstants.Raspberry_Pi.getImageName(),
                        KuraConstants.Raspberry_Pi.getImageVersion(), KuraConstants.Raspberry_Pi.getTargetName());
                supportedSerialModemInfo = supSerialModemInfo;
            }
