/* Copyright 2017, 2018 Wirepas Ltd. All Rights Reserved.
 *
...
typedef enum
{
    APP_QOS_NORMAL,  //!< Normal priority
    APP_QOS_HIGH,    //!< High priority
} app_qos_e;
...
typedef struct
{
    ...
    bool fast_transmission;             //!< Does fast transmission must be used
} app_message_t;
